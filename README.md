...
[![Status](https://img.shields.io/badge/status-active-success.svg)](https://github.com/eryajf/github-pages)
[![GitHub Issues](https://img.shields.io/github/issues/eryajf/github-pages.svg)](https://github.com/eryajf/github-pages/issues)
[![GitHub Pull Requests](https://img.shields.io/github/issues-pr/eryajf/github-pages)](https://github.com/eryajf/github-pages/pulls)
[![GitHub Pull Requests](https://img.shields.io/github/stars/eryajf/github-pages)](https://github.com/eryajf/github-pages/stargazers)
[![GitHub license](https://img.shields.io/github/license/eryajf/github-pages)](https://github.com/eryajf/github-pages/blob/main/LICENSE)
[![HitCount](https://views.whatilearened.today/views/github/eryajf/github-pages.svg)](https://github.com/eryajf/github-pages)
[![website eryajf.github.io/github-pages](https://img.shields.io/website-up-down-green-red/http/eryajf.github.io/github-pages.svg)](https://eryajf.github.io/github-pages/)
...
首先访问模板仓库：[github-pages](https://github.com/eryajf/github-pages)。点击此仓库右侧的 `Use this template`
...
> 这里有一个注意点：仓库的名字将会是 `GitHub Pages` 的访问一级路由。比如上边我仓库名字定义为：`github-pages`，那么配置成功之后的首页访问路径是： https://lql95.github.io/github-pages  ，如果你想让首页的访问路径是根，那么只需把仓库名字命名为：`lql95.github.io`。
...
```sh
$ git clone git@github.com:lql95/github-pages.git
```
